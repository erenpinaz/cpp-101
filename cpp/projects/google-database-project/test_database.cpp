// test_database.cpp, Maggie Johnson & Nejdet Eren Pinaz
//
...
int main() {
    ...
    Composer& comp2 =
        myDB.AddComposer("Johann Sebastian", "Bach", "Baroque", 1685,
                         "Bach had 20 children, several of whom became famous "
                         "musicians as well.");
    comp2.Promote(5);
